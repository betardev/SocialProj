...
var userInf = document.getElementById("loginInf").value;
if(password.length > 0 && userInf.length > 0){
	sendFormInfo();
}
...
function sendFormInfo(){
	...
	var url="CheckLoginInfo.jsp?loginInf=" + loginInfo + "&password=" + passwordInfo;
